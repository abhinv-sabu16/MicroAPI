 ...
 *   rateLimit       → rate limiting (in-memory, Redis on Day 21)
 *   versioning      → API version headers + validation  ← Day 9
 *   validation      → gateway-level Zod validation     ← Day 9
 *   jwt             → authenticate / requireRole
...
export { versionPlugin }        from './versioning.js';
